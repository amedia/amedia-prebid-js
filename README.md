...
- Then run the build:
        ...
        **BYGG FOR BAZAAR** gulp build --modules=adformBidAdapter,rubiconBidAdapter,appnexusBidAdapter,improvedigitalBidAdapter,adformOpenRTBAdapter,adploggerAnalyticsAdapter,currency,consentManagement
