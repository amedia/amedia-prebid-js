...
- Then run the build:
        ...
        **BYGG FOR BAZAAR** gulp build --modules=adformBidAdapter,rubiconBidAdapter,appnexusBidAdapter,improvedigitalBidAdapter,adformOpenRTBBidAdapter,smartxBidAdapter,adploggerAnalyticsAdapter,currency,dfpAdServerVideo
