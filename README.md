...
- Then run the build:
        ...
        **BYGG FOR BAZAAR** gulp build --modules=adformBidAdapter,rubiconBidAdapter,appnexusBidAdapter,improvedigitalBidAdapter,smartxBidAdapter,adploggerAnalyticsAdapter,currency,dfpAdServerVideo,adfBidAdapter
